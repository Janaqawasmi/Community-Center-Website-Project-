...
import {
  ...
  Button, Dialog, DialogTitle, DialogContent, DialogActions, MenuItem, Select, InputLabel, FormControl, Tab, Tabs
} from "@mui/material";
...
export default function AdminProgramAndEventRegistrations() {
  ...
  useEffect(() => {
    ...
    setFilteredEvents(data);
  }, [eventSearch, eventRegistrations]);

  // فتح نافذة التعديل للدورات
  ...
  return (
    <AdminDashboardLayout>
      <Box sx={{ p: 4 }}>
        ...
        {tab === 1 && (
          <>
            <Typography variant="h5" mb={2}>تسجيلات الفعاليات</Typography>
            <Box sx={{ display: "flex", gap: 2, mb: 2 }}>
              {/* مربع بحث خاص بالفعاليات */}
              <TextField
                label="بحث..."
                variant="outlined"
                sx={{ minWidth: 220 }}
                ...
                value={eventSearch}
                placeholder="اسم، اسم عائلة، رقم هوية، رقم هوية أب"
              />
              <Button
                variant="outlined"
